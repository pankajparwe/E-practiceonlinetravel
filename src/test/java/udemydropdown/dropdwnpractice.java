...
public class dropdwnpractice {
	public static void main(String[] args) {
		...
		// method 2 --it is changing one of the attribute value hence we are checking
		// the value
		// using if loop
		 ...
		 * 
		 * driver.findElement(By.xpath("(//a[@value='MAA'])[2]")).click(); //this
		 * selecting current date driver.findElement(By.
		 * xpath("//a[@class='ui-state-default ui-state-highlight']")).click();
		 * 
		 * 
		 * //================================================================ Handling
		 * dropdown cities // //a[@value='MAA'] - Xpath for chennai
		 * 
		 * //a[@value='BLR']
		 * 
		 * driver.findElement(By.id("ctl00_mainContent_ddl_originStation1_CTXT")).click(
		 ...
		 * ===
		 * 
		 * driver.findElement(By.id("ctl00_mainContent_chk_SeniorCitizenDiscount")).
		 * click();
		 * driver.findElement(By.id("ctl00_mainContent_chk_SeniorCitizenDiscount")).
		 * isSelected(); Assert.assertTrue(driver.findElement(By.id(
		 * "ctl00_mainContent_chk_SeniorCitizenDiscount")).isSelected());
		 * //==========================================================================
		 * 
		 * 
		 * //method for handling autosuggestive dropdown //1. click on the box //2. make
		 * list of the webelements and store it in variable , here optiins //3. use for
		 * loop to check the item
		 * 
		 * 
		 * driver.findElement(By.id("autosuggest")).sendKeys("ind"); List<WebElement>
		 ...
		 * 
		 * } option.click(); break;// for closing the loop when required element clicked
		 * 
		 * }
		 * 
		 */
